...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Expemses cannot be for the future.
        /// </summary>
        public static string EXPEMSES_CANNOT_FOR_FUTURE {
            get {
                return ResourceManager.GetString("EXPEMSES_CANNOT_FOR_FUTURE", resourceCulture);
            }
        }
